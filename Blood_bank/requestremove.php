...
<?php
    ...
    if(isset($_POST['removed'])){
      ...
      $exist="select * from requests where Email = '$email' ";

      //query to delete the row with that email
      $q="delete from requests where Email = '$email' ";
      ...
      <div class="container" >
          <div class="col-md-12">
              <div class="row w3-border-bottom">
                  <div><h1 style="text-align: center;">Remove Approved Requests</h1></div>
              </div>
              <form action="requestremove.php" method="post" style="margin-left: 300px;width:80%;">
                  <div class ="row">
                      <div class="col-md-6">
                          <div class="col-md-10" >
                              <div class="form-group">
                                  <label for="email">E-mail</label>
                                    ...
                                    <!--php code to show email of requests as options from db-->
                                    <?php
                                      //to retrieve data from requests table
                                      $extract="select * from requests";
                              ...
                              <button type="submit" class="btn" style="margin-left:70px;" name='removed' >Remove Request</button>
                          </div>
                      </div>
                  </div>
              </form>

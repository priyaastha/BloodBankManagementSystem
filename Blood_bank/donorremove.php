...
<?php
    ...
    if(isset($_POST['removed'])){
      ...
      $exist="select * from donors where Email = '$email' ";

      //query to delete the row with that email
      $q="delete from donors where Email = '$email' ";
      ...
      <div class="container" >
          <div class="col-md-12">
              <div class="row w3-border-bottom">
                  <div><h1 style="text-align: center;">Remove Donor</h1></div>
              </div>
              <form action="donorremove.php" method="post" style="margin-left: 300px;width:80%;">
                  <div class ="row">
                      <div class="col-md-6">
                          <div class="col-md-10" >
                              ...
                              <button type="submit" class="btn" style="margin-left:70px;" name='removed' >Remove Donor</button>
                          </div>
                      </div>
                  </div>
              </form>

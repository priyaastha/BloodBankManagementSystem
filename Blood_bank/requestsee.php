...
<?php
    ...
    //retrieve data from requests table in db
    ...
    $q=mysqli_query($connect,$check);
        ...
        while($row=mysqli_fetch_array($q)){
            echo("<tr style='font-size:18px;'><th>" .$row['Name']."</th><th>".$row['Bloodgroup']."</th><th>".$row['City']."</th><th>".$row['Pincode']."</th><th>".$row['Mobile']."</th><th>".$row['Email']."</th><br><br>");
        }
        //table closed
        echo "</table>";
?>
